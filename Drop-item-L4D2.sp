...
{
	CreateConVar("l4d_drop_version", "1.1", "Drop Weapon Version",FCVAR_NONE|FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	g_hSpecify = CreateConVar("l4d_drop_specify", "1", "Allow people to drop weapons they have, but are not using",FCVAR_NONE|FCVAR_SPONLY);
...
public Action Command_Drop(int client, int args)
{
	...
	char weapon[32];
	PrintToChatAll("To drop any inventory item, hold it then type !drop");
	PrintToChatAll("To drop a gas-can or propane-tank, press [USE] key :)");
	if (args > 1)
	{
